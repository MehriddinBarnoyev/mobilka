...
import { TagsItem } from '../../types/tags';
    ...
    const handleTagPress = useCallback(
        async (tag: string, tagId: number) => {
            ...
            try {
                ...
                const videosWithExp: Video[] = res.data.map((v: any) => ({
                    ...v,
                    name: v.title,
                            ...
                            return (
                                ...
                                >
                                    <View style={styles.tagHeader}>
                                        ...
                                        <View style={[styles.tagIcon, { backgroundColor: iconBgColor, width: scaleFont(30), height: scaleFont(30), borderRadius: scaleFont(15) }]}>
